  ...
  Drupal.behaviors.advanced_pwa = {
    attach: function (context, settings) {
      ...
      */
      ...
      // Here 2 ways to display confirmation: As modal or as embedded div. drupal.org issue https://www.drupal.org/project/advanced_pwa/issues/3073065
      var confirmation = {
        modal: Drupal.dialog('<div class="advanced_pwa_message_div" style="display: none !important;">' + Drupal.t('This site may send you push notifications.') + '</div>', {
        ...
        embedded: {
          open: function() {
            $('body').once('apwa').append('<div class="advanced_pwa-model-embedded">'
              + '<span class="text">' + Drupal.t('This site may send you push notifications.') + '</span>'
              + '<span class="button js--apwa-allow">' + Drupal.t('Allow') + '</span>'
              + '<span class="button js--apwa-cancel">' + Drupal.t('Later') + '</span>'
            + '</div>');
